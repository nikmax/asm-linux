; <script src="https://gist.github.com/bobbo/e1e980262f2ddc8db3b8.js"></script>
...
_start:
    ...
    ;; Main loop handles clients connecting 
    ;; (accept()) then echoes any input
    ;; back to the client
    .mainloop:
        call     _accept
...
;; Performs a sys_socket call to initialise a TCP/IP
;; listening socket, storing 
...
;; Accepts a connection from a client, storing the client 
;; socket file descriptor
;; in the client variable and logging the connection
;; to stdout
_accept:
    ;; Call sys_accept
    mov       rax, 43         ; SYS_ACCEPT
    mov       rdi, [sock]     ; listening socket fd
    mov       rsi, 0          ; NULL sockaddr_in value as
...
;; Calls the sys_write syscall, writing an error message
;; to stderr, then exits
;; the application. rsi and rdx must be populated with
...
;; Exits cleanly, checking if the listening or client sockets
;; need to be closed
